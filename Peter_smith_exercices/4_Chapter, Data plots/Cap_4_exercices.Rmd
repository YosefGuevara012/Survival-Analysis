...
plot(hz.plotting$Days,hz.plotting$Emp.h, main="Hazard Plot", xlab = "Days since heart transplant", ylab = "Hazard plot score", col="red")
```
...
Based on the calculations in the table above, we can say that the accumulated risk at 1000 days is 1.2918.
...
plot(log(newHeart$Days),inv_phi, main = "Lognormal distribution for heart transplant",xlab="log(Days)", sub="log-normal",ylab=expression(Phi^-1 * (S(t))))
